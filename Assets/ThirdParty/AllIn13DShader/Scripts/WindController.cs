...
namespace AllIn13DShader
{
	...
	{
		private static int MATPROP_GLOBAL_WIND_NOISE_TEX	= Shader.PropertyToID("global_windNoiseTex");
		private static int MATPROP_GLOBAL_WIND_FORCE		= Shader.PropertyToID("global_windForce");
		private static int MATPROP_GLOBAL_NOISE_SPEED		= Shader.PropertyToID("global_noiseSpeed");
		private static int MATPROP_GLOBAL_WIND_DIR			= Shader.PropertyToID("global_windDir");
		private static int MATPROP_GLOBAL_USE_WIND_DIR		= Shader.PropertyToID("global_useWindDir");
		private static int MATPROP_GLOBAL_MIN_WIND_VALUE	= Shader.PropertyToID("global_minWindValue");
		private static int MATPROP_GLOBAL_MAX_WIND_VALUE	= Shader.PropertyToID("global_maxWindValue");
		private static int MATPROP_GLOBAL_WIND_WORLD_SIZE	= Shader.PropertyToID("global_windWorldSize");
